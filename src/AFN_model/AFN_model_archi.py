...
class AFN_Model(nn.Module):
    def __init__(self, feature_extra_units, integrated_unit, num_feature_extra_units, attention_unit):
    ...
    def forward(self, x):
        # Check for incoming attention, apply attention mechanism
...
class AFNModelInitializer:
    def __init__(self, num_feature_extra_units, device, config, use_attention):
        self.num_feature_extra_units = num_feature_extra_units
        self.device = device
        self.config = config
    ...
    def create_afn_model(self):
        ...
        afn_model = AFN_Model(feature_extra_models, Integrated_unit_model, self.num_feature_extra_units, attention_model if self.use_attention else None)
